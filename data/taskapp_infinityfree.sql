-- Version compatible InfinityFree
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `task_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_pwd` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
